---
layout: page-toc
title: "CCNA 01 - Làm Quen Packet Tracer"
permalink: /writeups/ccna-packet-tracer-writeups/01-lam-quen-packet-tracer/
toc: true
---

# CCNA 01 - Làm Quen Packet Tracer
...
- Thiết bị mạng và thiết bị đầu cuối
- Quan sát topology
- Simulation/Realtimes cơ bản
...
[Tải file lab của dạng này](/writeups/ccna-packet-tracer-writeups/01-lam-quen-packet-tracer/downloads/)
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem; flex-wrap: wrap; gap: 1rem;">
  <div style="flex: 1; min-width: 200px;">
    <a href="/writeups/ccna-packet-tracer-writeups/00-full-lab-tu-dau-den-cuoi/">← 00. Full Lab Từ Đầu Đến Cuối</a>
  </div>
  <div style="text-align: center; flex: 0 0 auto;">
    <a href="/writeups/ccna-packet-tracer-writeups/01-lam-quen-packet-tracer/lab-01/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block; font-weight: 600;">Bắt đầu Lab 01 →</a>
  </div>
  <div style="flex: 1; min-width: 200px; text-align: right;">
    <a href="/writeups/ccna-packet-tracer-writeups/02-ios-va-cau-hinh-co-ban/">02. IOS Và Cấu Hình Cơ Bản →</a>
  </div>
</div>
