---
layout: page-toc
title: "CCNA 01 - Lý thuyết tổng hợp Làm quen Packet Tracer"
permalink: /writeups/ccna-packet-tracer-writeups/01-lam-quen-packet-tracer/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Làm quen Packet Tracer** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là nhận diện thiết bị, media, physical topology, logical topology và cách dùng Simulation Mode để quan sát PDU. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **End device, intermediary device và network media**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Physical topology so với logical topology**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **LAN, WAN, Internet cloud và đường đi của PDU**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Realtime Mode và Simulation Mode trong Packet Tracer**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Ghi chú topology, tên thiết bị và interface**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| End device, intermediary device và network media | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Physical topology so với logical topology | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| LAN, WAN, Internet cloud và đường đi của PDU | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Realtime Mode và Simulation Mode trong Packet Tracer | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Ghi chú topology, tên thiết bị và interface | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Nhầm thiết bị đầu cuối với thiết bị trung gian | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Chọn sai loại cáp hoặc sai port | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Chỉ nhìn sơ đồ vật lý mà không hiểu luồng logic | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không dùng Simulation Mode để xem packet đi qua từng lớp | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 1.5.7 Packet Tracer - Network Representation | `labs/lab-01/index.md` |
