---
layout: page-toc
title: "CCNA 02 - Lý thuyết tổng hợp IOS và cấu hình cơ bản"
permalink: /writeups/ccna-packet-tracer-writeups/02-ios-va-cau-hinh-co-ban/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **IOS và cấu hình cơ bản** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là làm chủ Cisco IOS CLI, cấu hình hostname, password, interface, SVI, gateway quản trị và lưu cấu hình. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **User EXEC, Privileged EXEC, Global Configuration và Interface Configuration**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Hostname, banner, enable secret, console và VTY line**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Địa chỉ IPv4 trên router interface và SVI của switch**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Default gateway cho switch Layer 2**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Running-config, startup-config và quy trình lưu cấu hình**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| User EXEC, Privileged EXEC, Global Configuration và Interface Configuration | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Hostname, banner, enable secret, console và VTY line | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Địa chỉ IPv4 trên router interface và SVI của switch | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Default gateway cho switch Layer 2 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Running-config, startup-config và quy trình lưu cấu hình | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Sai mode cấu hình nên lệnh không chạy | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Quên `no shutdown` trên interface | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Gán IP vào sai interface | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Switch thiếu `ip default-gateway` | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Đặt password nhưng quên `login` | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không lưu cấu hình sau khi hoàn tất | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 1.4.7 Packet Tracer - Configure Router Interfaces | `labs/lab-01/index.md` |
| 2.3.7 Packet Tracer - Navigate the IOS | `labs/lab-02/index.md` |
| 2.5.5 Packet Tracer - Configure Initial Switch Settings | `labs/lab-03/index.md` |
| 2.9.1 Packet Tracer - Basic Switch and End Device Configuration | `labs/lab-04/index.md` |
| 10.1.4 Packet Tracer - Configure Initial Router Settings | `labs/lab-05/index.md` |
| 10.3.4 Packet Tracer - Connect a Router to a LAN | `labs/lab-06/index.md` |
| 10.4.3 Packet Tracer - Basic Device Configuration | `labs/lab-07/index.md` |
| 14.3.5 Packet Tracer - Basic Router Configuration Review | `labs/lab-08/index.md` |
