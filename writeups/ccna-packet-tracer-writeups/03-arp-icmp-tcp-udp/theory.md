---
layout: page-toc
title: "CCNA 03 - Lý thuyết tổng hợp ARP, ICMP, TCP và UDP"
permalink: /writeups/ccna-packet-tracer-writeups/03-arp-icmp-tcp-udp/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **ARP, ICMP, TCP và UDP** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là hiểu encapsulation, phân biệt MAC/IP, quan sát ARP, IPv6 Neighbor Discovery, ICMP ping và phiên TCP/UDP. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **Encapsulation và de-encapsulation qua OSI/TCP-IP**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Địa chỉ MAC dùng trong local link, địa chỉ IP dùng end-to-end**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **ARP request/reply trong IPv4**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Neighbor Discovery trong IPv6**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **ICMP echo request/reply dùng cho ping**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **TCP three-way handshake và UDP best-effort**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| Encapsulation và de-encapsulation qua OSI/TCP-IP | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Địa chỉ MAC dùng trong local link, địa chỉ IP dùng end-to-end | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| ARP request/reply trong IPv4 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Neighbor Discovery trong IPv6 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| ICMP echo request/reply dùng cho ping | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| TCP three-way handshake và UDP best-effort | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Nhầm MAC address là địa chỉ đi end-to-end | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Quên ARP chỉ hoạt động trong local broadcast domain | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Ping fail do gateway sai nhưng lại debug TCP trước | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không xóa hoặc quan sát lại ARP cache khi test | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Nhầm port TCP/UDP với địa chỉ IP | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 3.5.5 Packet Tracer - Investigate the TCP-IP and OSI Models in Action | `labs/lab-01/index.md` |
| 9.1.3 Packet Tracer - Identify MAC and IP Addresses | `labs/lab-02/index.md` |
| 9.2.9 Packet Tracer - Examine the ARP Table | `labs/lab-03/index.md` |
| 9.3.4 Packet Tracer - IPv6 Neighbor Discovery | `labs/lab-04/index.md` |
| 14.8.1 Packet Tracer - TCP and UDP Communications | `labs/lab-05/index.md` |
