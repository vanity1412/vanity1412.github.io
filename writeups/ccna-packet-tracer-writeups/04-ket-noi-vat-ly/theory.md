---
layout: page-toc
title: "CCNA 04 - Lý thuyết tổng hợp Kết nối vật lý"
permalink: /writeups/ccna-packet-tracer-writeups/04-ket-noi-vat-ly/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Kết nối vật lý** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là đọc cổng thiết bị, chọn dây đúng, kiểm tra link light, interface status và connectivity có dây/không dây. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **Physical layer media: copper, fiber, serial và wireless**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Port/interface naming trên router, switch và end device**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Link status, line protocol và ý nghĩa up/down**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Basic IP settings để kiểm tra kết nối**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Kết nối wired LAN với wireless LAN**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| Physical layer media: copper, fiber, serial và wireless | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Port/interface naming trên router, switch và end device | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Link status, line protocol và ý nghĩa up/down | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Basic IP settings để kiểm tra kết nối | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Kết nối wired LAN với wireless LAN | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Cắm sai port | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Dùng sai loại cáp trong bài yêu cầu chọn thủ công | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Interface shutdown | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Link vật lý xanh nhưng IP/mask/gateway sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Ping end-to-end trước khi kiểm tra từng đoạn | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 2.7.6 Packet Tracer - Implement Basic Connectivity | `labs/lab-01/index.md` |
| 2.8.1 Video Activity - Test the Interface Assignment | `labs/lab-02/index.md` |
| 2.8.2 Video Activity - Test End-to-End Connectivity | `labs/lab-03/index.md` |
| 4.6.5 Packet Tracer - Connect a Wired and Wireless LAN | `labs/lab-04/index.md` |
| 4.7.1 Packet Tracer - Connect the Physical Layer | `labs/lab-05/index.md` |
