---
layout: page-toc
title: "CCNA 07.01 - 5.1.9 Packet Tracer - Investigate STP Loop Prevention"
permalink: /writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/lab-01/
toc: true
---
...
![Topology lab 01](/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/labs/lab-01/topology.png)
![Instructions lab 01](/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/labs/lab-01/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/lab-02/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 2 →</a></div>
  </div>
  
  <details open>
    <summary style="cursor: pointer; font-weight: 600; margin-bottom: 1rem;">Danh sách 4 lab trong dạng này:</summary>
    <ul style="list-style: none; padding-left: 0;">
  <li style="margin: 0.5rem 0;"><strong>→ Lab 1: 5.1.9 Packet Tracer - Investigate STP Loop Prevention (Đang đọc)</strong></li>
