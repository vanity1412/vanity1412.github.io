---
layout: page-toc
title: "CCNA 07.04 - 6.4.1 Packet Tracer - Implement Etherchannel"
permalink: /writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/lab-04/
toc: true
---
...
![Topology lab 04](/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/labs/lab-04/topology.png)
![Instructions lab 04](/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/labs/lab-04/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/lab-03/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 3</a></div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 4: 6.4.1 Packet Tracer - Implement Etherchannel (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
