---
layout: page-toc
title: "CCNA 07 - Lý thuyết tổng hợp STP và EtherChannel"
permalink: /writeups/ccna-packet-tracer-writeups/07-stp-etherchannel/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **STP và EtherChannel** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là ngăn loop Layer 2 bằng STP, hiểu root bridge/port role, sau đó gom link bằng EtherChannel LACP/PAgP. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **Layer 2 loop và broadcast storm**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **STP root bridge election bằng priority và MAC**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Root port, designated port và alternate/blocked port**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **PortFast/BPDU Guard ở access edge**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **EtherChannel như một logical link**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **LACP active/passive và PAgP desirable/auto**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| Layer 2 loop và broadcast storm | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| STP root bridge election bằng priority và MAC | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Root port, designated port và alternate/blocked port | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| PortFast/BPDU Guard ở access edge | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| EtherChannel như một logical link | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| LACP active/passive và PAgP desirable/auto | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Root bridge không như mong muốn do priority/MAC | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Cấu hình PortFast nhầm trên uplink/trunk | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Hai đầu EtherChannel khác protocol hoặc khác mode | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Thông số trunk/access không đồng nhất trong bundle | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Cấu hình trên physical port nhưng quên Port-channel | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 5.1.9 Packet Tracer - Investigate STP Loop Prevention | `labs/lab-01/index.md` |
| 6.2.4 Packet Tracer - Configure EtherChannel | `labs/lab-02/index.md` |
| 6.3.4 Packet Tracer - Troubleshoot EtherChannel | `labs/lab-03/index.md` |
| 6.4.1 Packet Tracer - Implement Etherchannel | `labs/lab-04/index.md` |
