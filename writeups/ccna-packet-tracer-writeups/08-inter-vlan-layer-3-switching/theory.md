---
layout: page-toc
title: "CCNA 08 - Lý thuyết tổng hợp Inter-VLAN Routing và Layer 3 Switching"
permalink: /writeups/ccna-packet-tracer-writeups/08-inter-vlan-layer-3-switching/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Inter-VLAN Routing và Layer 3 Switching** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là định tuyến giữa VLAN bằng router-on-a-stick, subinterface dot1Q, SVI trên multilayer switch và routed port. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **VLAN tách Layer 2 nên cần Layer 3 để liên lạc**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Router-on-a-stick dùng trunk tới router**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Subinterface cần `encapsulation dot1Q` đúng VLAN**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **SVI trên Layer 3 switch làm default gateway cho VLAN**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **`ip routing` bật chức năng routing trên multilayer switch**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Troubleshooting theo host gateway, trunk và route**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| VLAN tách Layer 2 nên cần Layer 3 để liên lạc | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Router-on-a-stick dùng trunk tới router | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Subinterface cần `encapsulation dot1Q` đúng VLAN | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| SVI trên Layer 3 switch làm default gateway cho VLAN | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| `ip routing` bật chức năng routing trên multilayer switch | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Troubleshooting theo host gateway, trunk và route | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Trunk tới router chưa cho VLAN đi qua | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Subinterface sai VLAN ID hoặc thiếu dot1Q | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Host đặt sai default gateway | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| SVI down vì VLAN chưa tồn tại hoặc không có port up | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Quên `ip routing` trên Layer 3 switch | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 4.2.7 Packet Tracer - Configure Router-on-a-Stick Inter-VLAN Routing | `labs/lab-01/index.md` |
| 4.3.8 Packet Tracer - Configure Layer 3 Switching and Inter-VLAN Routing | `labs/lab-02/index.md` |
| 4.4.8 Packet Tracer - Troubleshoot Inter-VLAN Routing | `labs/lab-03/index.md` |
| 4.5.1 Packet Tracer - Inter-VLAN Routing Challenge | `labs/lab-04/index.md` |
