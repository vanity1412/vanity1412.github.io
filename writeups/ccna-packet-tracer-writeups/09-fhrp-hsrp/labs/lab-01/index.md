---
layout: page-toc
title: "CCNA 09.01 - 9.3.3 Packet Tracer - HSRP Configuration Guide"
permalink: /writeups/ccna-packet-tracer-writeups/09-fhrp-hsrp/lab-01/
toc: true
---
...
![Topology lab 01](/writeups/ccna-packet-tracer-writeups/09-fhrp-hsrp/labs/lab-01/topology.png)
![Instructions lab 01](/writeups/ccna-packet-tracer-writeups/09-fhrp-hsrp/labs/lab-01/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><span></span></div>
    <div><a href="/writeups/ccna-packet-tracer-writeups/09-fhrp-hsrp/" style="padding: 0.5rem 1rem; border: 1px solid #cbd5e1; border-radius: 6px; text-decoration: none; display: inline-block;">📋 Xem tất cả</a></div>
    <div><span></span></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 1: 9.3.3 Packet Tracer - HSRP Configuration Guide (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
