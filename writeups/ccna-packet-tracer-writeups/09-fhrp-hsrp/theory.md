---
layout: page-toc
title: "CCNA 09 - Lý thuyết tổng hợp FHRP và HSRP"
permalink: /writeups/ccna-packet-tracer-writeups/09-fhrp-hsrp/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **FHRP và HSRP** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là tạo default gateway dự phòng bằng HSRP virtual IP, active/standby router, priority, preempt và tracking. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **FHRP tránh single point of failure ở default gateway**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **HSRP virtual IP là gateway mà host sử dụng**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Active router forward traffic, standby router chờ thay thế**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Priority quyết định router active**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Preempt cho router ưu tiên cao giành lại vai trò**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Interface tracking giảm priority khi uplink lỗi**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| FHRP tránh single point of failure ở default gateway | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| HSRP virtual IP là gateway mà host sử dụng | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Active router forward traffic, standby router chờ thay thế | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Priority quyết định router active | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Preempt cho router ưu tiên cao giành lại vai trò | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Interface tracking giảm priority khi uplink lỗi | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Host dùng physical IP thay vì virtual IP | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Virtual IP không cùng subnet với host | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Priority đúng nhưng thiếu preempt | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Hai router khác group | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không cấu hình tracking nên failover không phản ánh uplink | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 9.3.3 Packet Tracer - HSRP Configuration Guide | `labs/lab-01/index.md` |
