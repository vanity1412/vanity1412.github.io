---
layout: page-toc
title: "CCNA 10 - Lý thuyết tổng hợp Static và Default Routing"
permalink: /writeups/ccna-packet-tracer-writeups/10-static-default-routing/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Static và Default Routing** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là đọc connected route, cấu hình static route IPv4/IPv6, default route và xử lý lỗi route hai chiều. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **Connected route xuất hiện khi interface up/up**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Static route chỉ đường tới remote network**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Default route dùng khi không có route cụ thể hơn**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Next-hop phải reachable**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Administrative distance và floating static route**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **IPv4 `ip route` khác IPv6 `ipv6 route`**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| Connected route xuất hiện khi interface up/up | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Static route chỉ đường tới remote network | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Default route dùng khi không có route cụ thể hơn | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Next-hop phải reachable | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Administrative distance và floating static route | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| IPv4 `ip route` khác IPv6 `ipv6 route` | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Sai network hoặc mask trong static route | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Next-hop không reachable | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Thiếu route chiều về | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Interface down làm connected route biến mất | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Default route trỏ sai hướng | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Floating route có AD không đúng | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 1.5.10 Packet Tracer - Verify Directly Connected Networks | `labs/lab-01/index.md` |
| 15.6.1 Packet Tracer - Configure IPv4 and IPv6 Static and Default Routes | `labs/lab-02/index.md` |
| 16.3.1 Packet Tracer - Troubleshoot Static and Default Routes | `labs/lab-03/index.md` |
