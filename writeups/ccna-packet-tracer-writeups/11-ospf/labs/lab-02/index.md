---
layout: page-toc
title: "CCNA 11.02 - 2.3.11 Packet Tracer - Determine the DR and BDR"
permalink: /writeups/ccna-packet-tracer-writeups/11-ospf/lab-02/
toc: true
---
...
![Topology lab 02](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-02/topology.png)
![Instructions lab 02](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-02/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-01/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 1</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-03/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 3 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 2: 2.3.11 Packet Tracer - Determine the DR and BDR (Đang đọc)</strong></li>
