---
layout: page-toc
title: "CCNA 11.04 - 2.5.3 Packet Tracer - Propagate a Default Route in OSPFv2"
permalink: /writeups/ccna-packet-tracer-writeups/11-ospf/lab-04/
toc: true
---
...
![Topology lab 04](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-04/topology.png)
![Instructions lab 04](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-04/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-03/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 3</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-05/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 5 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 4: 2.5.3 Packet Tracer - Propagate a Default Route in OSPFv2 (Đang đọc)</strong></li>
