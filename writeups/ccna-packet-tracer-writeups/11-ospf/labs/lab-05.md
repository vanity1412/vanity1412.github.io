---
layout: page-toc
title: "CCNA 11.05 - 2.6.6 Packet Tracer - Verify Single-Area OSPFv2"
permalink: /writeups/ccna-packet-tracer-writeups/11-ospf/lab-05/
toc: true
---

# CCNA 11.05 - 2.6.6 Packet Tracer - Verify Single-Area OSPFv2
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-04/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 4</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-06/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 6 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 5: 2.6.6 Packet Tracer - Verify Single-Area OSPFv2 (Đang đọc)</strong></li>
