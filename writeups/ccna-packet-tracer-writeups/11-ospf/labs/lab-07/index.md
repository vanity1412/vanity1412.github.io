---
layout: page-toc
title: "CCNA 11.07 - ospf_full"
permalink: /writeups/ccna-packet-tracer-writeups/11-ospf/lab-07/
toc: true
---
...
![Topology lab 07](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-07/topology.png)
![Instructions lab 07](/writeups/ccna-packet-tracer-writeups/11-ospf/labs/lab-07/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/11-ospf/lab-06/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 6</a></div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 7: ospf_full (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
