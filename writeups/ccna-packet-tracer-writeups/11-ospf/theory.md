---
layout: page-toc
title: "CCNA 11 - Lý thuyết tổng hợp OSPF"
permalink: /writeups/ccna-packet-tracer-writeups/11-ospf/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **OSPF** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là cấu hình single-area OSPFv2, neighbor adjacency, router ID, wildcard mask, DR/BDR, cost và default route propagation. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **OSPF là link-state IGP dùng LSDB và SPF**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Neighbor adjacency cần cùng area, timer, network type và authentication**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Router ID định danh router trong OSPF domain**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Wildcard mask chọn interface tham gia OSPF**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **DR/BDR xuất hiện trên multiaccess network**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Cost ảnh hưởng đường đi tốt nhất**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Default-information originate quảng bá default route**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| OSPF là link-state IGP dùng LSDB và SPF | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Neighbor adjacency cần cùng area, timer, network type và authentication | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Router ID định danh router trong OSPF domain | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Wildcard mask chọn interface tham gia OSPF | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| DR/BDR xuất hiện trên multiaccess network | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Cost ảnh hưởng đường đi tốt nhất | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Wildcard mask sai làm interface không chạy OSPF | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Area mismatch | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Router ID trùng | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Passive-interface đặt nhầm uplink | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| DR/BDR khác kỳ vọng do priority/router ID | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Thiếu default route trước khi originate | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 2.2.13 Packet Tracer - Point-to-Point Single-Area OSPFv2 Configuration | `labs/lab-01/index.md` |
| 2.3.11 Packet Tracer - Determine the DR and BDR | `labs/lab-02/index.md` |
| 2.4.11 Packet Tracer - Modify Single-Area OSPFv2 | `labs/lab-03/index.md` |
| 2.5.3 Packet Tracer - Propagate a Default Route in OSPFv2 | `labs/lab-04/index.md` |
| 2.6.6 Packet Tracer - Verify Single-Area OSPFv2 | `labs/lab-05/index.md` |
| 2.7.1 Packet Tracer - Single-Area OSPFv2 Configuration | `labs/lab-06/index.md` |
| ospf_full | `labs/lab-07/index.md` |
