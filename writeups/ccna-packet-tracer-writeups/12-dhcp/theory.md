---
layout: page-toc
title: "CCNA 12 - Lý thuyết tổng hợp DHCP"
permalink: /writeups/ccna-packet-tracer-writeups/12-dhcp/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **DHCP** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là cấu hình DHCPv4 pool, excluded address, default-router, DNS, binding và DHCP relay bằng helper-address. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **DHCP cấp địa chỉ động cho client**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **DORA gồm Discover, Offer, Request, Acknowledgment**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **DHCP pool định nghĩa network, gateway và DNS**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Excluded address bảo vệ IP tĩnh như gateway/server**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **DHCP binding cho biết client nhận IP nào**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **DHCP relay chuyển broadcast qua router bằng helper-address**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| DHCP cấp địa chỉ động cho client | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| DORA gồm Discover, Offer, Request, Acknowledgment | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| DHCP pool định nghĩa network, gateway và DNS | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Excluded address bảo vệ IP tĩnh như gateway/server | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| DHCP binding cho biết client nhận IP nào | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| DHCP relay chuyển broadcast qua router bằng helper-address | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Pool network/mask sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Quên exclude gateway hoặc server | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Client ở subnet khác thiếu `ip helper-address` | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| DHCP server không reachable | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Default-router trong pool sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Pool hết địa chỉ usable | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 7.2.10 Packet Tracer - Configure DHCPv4 | `labs/lab-01/index.md` |
| 7.4.1 Packet Tracer - Implement DHCPv4 | `labs/lab-02/index.md` |
