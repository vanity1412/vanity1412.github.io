---
layout: page-toc
title: "CCNA 14.06 - Dynamic_nat"
permalink: /writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-06/
toc: true
---

# CCNA 14.06 - Dynamic_nat
...
~~~md
![Topology lab 06](../images/lab-06/topology.png)
![Instructions lab 06](../images/lab-06/instructions.png)
~~~
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-05/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 5</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-07/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 7 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 6: Dynamic_nat (Đang đọc)</strong></li>
