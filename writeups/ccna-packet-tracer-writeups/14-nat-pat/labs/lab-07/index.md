---
layout: page-toc
title: "CCNA 14.07 - nat_port"
permalink: /writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-07/
toc: true
---
...
![Topology lab 07](/writeups/ccna-packet-tracer-writeups/14-nat-pat/labs/lab-07/topology.png)
![Instructions lab 07](/writeups/ccna-packet-tracer-writeups/14-nat-pat/labs/lab-07/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-06/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 6</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-08/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 8 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 7: nat_port (Đang đọc)</strong></li>
