---
layout: page-toc
title: "CCNA 14.08 - static_nat"
permalink: /writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-08/
toc: true
---
...
![Topology lab 08](/writeups/ccna-packet-tracer-writeups/14-nat-pat/labs/lab-08/topology.png)
![Instructions lab 08](/writeups/ccna-packet-tracer-writeups/14-nat-pat/labs/lab-08/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/14-nat-pat/lab-07/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 7</a></div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 8: static_nat (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
