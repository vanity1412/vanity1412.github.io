---
layout: page-toc
title: "CCNA 14 - Lý thuyết tổng hợp NAT và PAT"
permalink: /writeups/ccna-packet-tracer-writeups/14-nat-pat/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **NAT và PAT** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là dịch địa chỉ IPv4 bằng static NAT, dynamic NAT, PAT overload, port forwarding, inside/outside và translation table. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **NAT dịch private IPv4 sang public IPv4**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Inside local, inside global, outside local, outside global**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Static NAT ánh xạ 1-1**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Dynamic NAT dùng pool public**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **PAT overload nhiều host qua một IP bằng port**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Port forwarding publish dịch vụ nội bộ ra ngoài**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| NAT dịch private IPv4 sang public IPv4 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Inside local, inside global, outside local, outside global | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Static NAT ánh xạ 1-1 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Dynamic NAT dùng pool public | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| PAT overload nhiều host qua một IP bằng port | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Port forwarding publish dịch vụ nội bộ ra ngoài | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Đánh dấu nhầm inside/outside interface | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| ACL NAT không match mạng inside | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Pool public sai hoặc hết địa chỉ | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Thiếu overload khi cần PAT | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Static NAT trùng dynamic pool | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không tạo traffic nên bảng translation trống | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 6.2.7 Packet Tracer - Investigate NAT Operation | `labs/lab-01/index.md` |
| 6.4.5 Packet Tracer - Configure Static NAT | `labs/lab-02/index.md` |
| 6.5.6 Packet Tracer - Configure Dynamic NAT | `labs/lab-03/index.md` |
| 6.6.7 Packet Tracer - Configure PAT | `labs/lab-04/index.md` |
| 6.8.1 Packet Tracer - Configure NAT for IPv4 | `labs/lab-05/index.md` |
| Dynamic_nat | `labs/lab-06/index.md` |
| nat_port | `labs/lab-07/index.md` |
| static_nat | `labs/lab-08/index.md` |
