---
layout: page-toc
title: "CCNA 15 - Lý thuyết tổng hợp Wireless và WLAN"
permalink: /writeups/ccna-packet-tracer-writeups/15-wireless-wlan/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Wireless và WLAN** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là cấu hình SSID, wireless router, WLC, AP, WPA2 Personal/Enterprise, VLAN mapping và xử lý lỗi WLAN. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **WLAN mở rộng LAN bằng sóng radio 802.11**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **SSID là tên mạng không dây**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **WPA2-PSK dùng shared key**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **WPA2-Enterprise dùng 802.1X/RADIUS**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **WLC quản lý lightweight AP và WLAN profile**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **WLAN có thể map vào VLAN/subnet riêng**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| WLAN mở rộng LAN bằng sóng radio 802.11 | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| SSID là tên mạng không dây | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| WPA2-PSK dùng shared key | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| WPA2-Enterprise dùng 802.1X/RADIUS | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| WLC quản lý lightweight AP và WLAN profile | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| WLAN có thể map vào VLAN/subnet riêng | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Sai SSID hoặc passphrase | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Client không nhận DHCP | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| WLAN map sai VLAN/interface | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| AP không join WLC | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| RADIUS shared secret hoặc credential sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Tín hiệu/khoảng cách không phù hợp trong Packet Tracer | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 13.1.10 Packet Tracer - Configure a Wireless Network | `labs/lab-01/index.md` |
| 13.2.7 Packet Tracer - Configure a Basic WLAN on the WLC | `labs/lab-02/index.md` |
| 13.3.12 Packet Tracer - Configure a WPA2 Enterprise WLAN on the WLC | `labs/lab-03/index.md` |
| 13.4.5 Packet Tracer - Troubleshoot WLAN Issues | `labs/lab-04/index.md` |
| 13.5.1 Packet Tracer - WLAN Configuration | `labs/lab-05/index.md` |
