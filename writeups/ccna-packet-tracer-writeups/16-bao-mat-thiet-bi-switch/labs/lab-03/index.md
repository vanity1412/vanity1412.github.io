---
layout: page-toc
title: "CCNA 16.03 - 11.6.1 Packet Tracer - Switch Security Configuration"
permalink: /writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-03/
toc: true
---
...
![Topology lab 03](/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/labs/lab-03/topology.png)
![Instructions lab 03](/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/labs/lab-03/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-02/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 2</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-06/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 6 →</a></div>
  </div>
  
  <details open>
    <summary style="cursor: pointer; font-weight: 600; margin-bottom: 1rem;">Danh sách 4 lab trong dạng này:</summary>
    <ul style="list-style: none; padding-left: 0;">
  <li style="margin: 0.5rem 0;"><a href="/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-01/">Lab 1: 1.3.6 Packet Tracer - Configure SSH</a></li>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 3: 11.6.1 Packet Tracer - Switch Security Configuration (Đang đọc)</strong></li>
