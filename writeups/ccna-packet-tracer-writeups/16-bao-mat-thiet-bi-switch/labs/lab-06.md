---
layout: page-toc
title: "CCNA 16.06 - 16.5.1 Packet Tracer - Secure Network Devices"
permalink: /writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-06/
toc: true
---

# CCNA 16.06 - 16.5.1 Packet Tracer - Secure Network Devices
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/16-bao-mat-thiet-bi-switch/lab-03/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 3</a></div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 6: 16.5.1 Packet Tracer - Secure Network Devices (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
