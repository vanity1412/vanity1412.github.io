---
layout: page-toc
title: "CCNA 17.03 - 10.3.4 Packet Tracer - Configure and Verify NTP"
permalink: /writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/lab-03/
toc: true
---
...
![Topology lab 03](/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/labs/lab-03/topology.png)
![Instructions lab 03](/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/labs/lab-03/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/lab-02/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 2</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/lab-04/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 4 →</a></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 3: 10.3.4 Packet Tracer - Configure and Verify NTP (Đang đọc)</strong></li>
