---
layout: page-toc
title: "CCNA 17.06 - 10.8.1 Packet Tracer - Configure CDP, LLDP, and NTP"
permalink: /writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/lab-06/
toc: true
---
...
![Topology lab 06](/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/labs/lab-06/topology.png)
![Instructions lab 06](/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/labs/lab-06/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/lab-05/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 5</a></div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 6: 10.8.1 Packet Tracer - Configure CDP, LLDP, and NTP (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
