---
layout: page-toc
title: "CCNA 17 - Lý thuyết tổng hợp Quản trị mạng"
permalink: /writeups/ccna-packet-tracer-writeups/17-quan-tri-mang/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Quản trị mạng** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là dùng CDP/LLDP map topology, đồng bộ NTP, backup cấu hình qua TFTP và nâng cấp IOS image. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **CDP là discovery protocol của Cisco**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **LLDP là discovery protocol chuẩn mở**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Neighbor table giúp map topology và kiểm tra port kết nối**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **NTP đồng bộ thời gian cho log và troubleshooting**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **TFTP dùng để backup/restore cấu hình**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **IOS image upgrade cần kiểm tra flash, image và boot variable**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| CDP là discovery protocol của Cisco | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| LLDP là discovery protocol chuẩn mở | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Neighbor table giúp map topology và kiểm tra port kết nối | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| NTP đồng bộ thời gian cho log và troubleshooting | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| TFTP dùng để backup/restore cấu hình | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| IOS image upgrade cần kiểm tra flash, image và boot variable | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| CDP/LLDP bị tắt trên device hoặc interface | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| NTP không sync do route/gateway sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Sai IP TFTP server | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không đủ flash trước khi copy IOS | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Boot variable trỏ sai image | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Không backup trước khi upgrade | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 10.1.5 Packet Tracer - Use CDP to Map a Network | `labs/lab-01/index.md` |
| 10.2.6  Packet Tracer - Use LLDP to Map a Network | `labs/lab-02/index.md` |
| 10.3.4 Packet Tracer - Configure and Verify NTP | `labs/lab-03/index.md` |
| 10.6.10 Packet Tracer - Back Up Configuration Files | `labs/lab-04/index.md` |
| 10.7.6 Packet Tracer - Use a TFTP Server to Upgrade a Cisco IOS Image | `labs/lab-05/index.md` |
| 10.8.1 Packet Tracer - Configure CDP, LLDP, and NTP | `labs/lab-06/index.md` |
