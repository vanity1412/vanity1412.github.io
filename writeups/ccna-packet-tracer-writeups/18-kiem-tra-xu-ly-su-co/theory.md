---
layout: page-toc
title: "CCNA 18 - Lý thuyết tổng hợp Kiểm tra và xử lý sự cố"
permalink: /writeups/ccna-packet-tracer-writeups/18-kiem-tra-xu-ly-su-co/theory/
toc: true
---

## Phần 1: Tổng quan về chủ đề

Chủ đề **Kiểm tra và xử lý sự cố** trong CCNA giúp người học hiểu cách một mảng kiến thức mạng vận hành trong Packet Tracer và trong mạng doanh nghiệp nhỏ. Trọng tâm của track này là dùng ping, traceroute, ICMP, show commands và checklist để khoanh vùng lỗi connectivity. Nếu chỉ làm theo từng bước của lab, bạn có thể hoàn thành bài nhưng vẫn chưa nhìn ra logic chung. Vì vậy trang này gom lại kiến thức nền, quy trình kiểm tra và các lỗi lặp lại trong toàn bộ lab của track.
...
- **Troubleshooting theo lớp: physical, data link, network, service**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Ping dùng ICMP để kiểm tra reachability**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Traceroute xác định hop/path**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Default gateway là điểm ra khỏi subnet**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **Show command output phản ánh trạng thái thật**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.
- **So sánh expected state với actual state**: cần hiểu bản chất, lệnh kiểm tra và dấu hiệu đúng/sai trong lab.

| Khái niệm | Ý nghĩa | Cách kiểm chứng |
| --- | --- | --- |
| Troubleshooting theo lớp: physical, data link, network, service | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Ping dùng ICMP để kiểm tra reachability | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Traceroute xác định hop/path | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Default gateway là điểm ra khỏi subnet | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| Show command output phản ánh trạng thái thật | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
| So sánh expected state với actual state | Vai trò cốt lõi của chủ đề | Kiểm tra bằng lệnh/GUI phù hợp trong Packet Tracer |
...
| --- | --- | --- |
| Default gateway sai hoặc thiếu | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Interface shutdown | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Sai IP/mask | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Cable hoặc port sai | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Thiếu route chiều về | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
| Chỉ kiểm tra endpoint mà bỏ qua từng hop | Đối chiếu topology, cấu hình và output kiểm tra | Sửa đúng điểm gây lỗi rồi test lại từ gần đến xa |
...
| Lab | File |
| --- | --- |
| 10.3.5 Packet Tracer - Troubleshoot Default Gateway Issues | `labs/lab-01/index.md` |
| 13.2.7 Packet Tracer - Use Ping and Traceroute to Test Network Connectivity | `labs/lab-02/index.md` |
| 13.3.1 Packet Tracer - Use ICMP to Test and Correct Network Connectivity | `labs/lab-03/index.md` |
| 17.5.9 Packet Tracer - Interpret show Command Output | `labs/lab-04/index.md` |
| 17.7.7 Packet Tracer - Troubleshoot Connectivity Issues | `labs/lab-05/index.md` |
| 17.8.3 Packet Tracer - Troubleshooting Challenge | `labs/lab-06/index.md` |
