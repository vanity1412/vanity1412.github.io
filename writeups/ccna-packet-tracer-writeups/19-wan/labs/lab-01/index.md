---
layout: page-toc
title: "CCNA 19.01 - 7.6.1 Packet Tracer - WAN Concepts"
permalink: /writeups/ccna-packet-tracer-writeups/19-wan/lab-01/
toc: true
---
...
![Topology lab 01](/writeups/ccna-packet-tracer-writeups/19-wan/labs/lab-01/topology.png)
![Instructions lab 01](/writeups/ccna-packet-tracer-writeups/19-wan/labs/lab-01/instructions.png)
...
- `Quan sát topology`
- `Kiểm tra bảng địa chỉ`
- `ping/traceroute nếu có`
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><span></span></div>
    <div><a href="/writeups/ccna-packet-tracer-writeups/19-wan/" style="padding: 0.5rem 1rem; border: 1px solid #cbd5e1; border-radius: 6px; text-decoration: none; display: inline-block;">📋 Xem tất cả</a></div>
    <div><span></span></div>
  </div>
  ...
  <li style="margin: 0.5rem 0;"><strong>→ Lab 1: 7.6.1 Packet Tracer - WAN Concepts (Đang đọc)</strong></li>
    </ul>
  </details>
</div>
