---
layout: page-toc
title: "CCNA 20.02 - 17.8.2 Packet Tracer - Skills Integration Challenge"
permalink: /writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/lab-02/
toc: true
---
...
![Topology lab 02](/writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/labs/lab-02/topology.png)
![Instructions lab 02](/writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/labs/lab-02/instructions.png)
...
<div style="margin: 2rem 0;">
  <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div><a href="/writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/lab-01/" style="padding: 0.5rem 1rem; background: #e2e8f0; color: #1e293b; border-radius: 6px; text-decoration: none; display: inline-block;">← Lab 1</a></div>
    ...
    <div><a href="/writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/lab-03/" style="padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 6px; text-decoration: none; display: inline-block;">Lab 3 →</a></div>
  </div>
  
  <details open>
    <summary style="cursor: pointer; font-weight: 600; margin-bottom: 1rem;">Danh sách 3 lab trong dạng này:</summary>
    <ul style="list-style: none; padding-left: 0;">
  <li style="margin: 0.5rem 0;"><a href="/writeups/ccna-packet-tracer-writeups/20-bai-tong-hop/lab-01/">Lab 1: 1.6.1 Packet Tracer - Implement a Small Network</a></li>
  <li style="margin: 0.5rem 0;"><strong>→ Lab 2: 17.8.2 Packet Tracer - Skills Integration Challenge (Đang đọc)</strong></li>
